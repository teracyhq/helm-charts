...
Feature: The features on each plan 
	...
	################# PREMIUM PLAN ###############
Scenario: Premium plan - change the creator (11) 
	...
	And The variable "var_creator" should be equal "2"
...
#Scenario: Premium Plan - check the supported features in Private Plan (12) 
# see scenarios: 2, 3, 4, 5
Scenario: Premium Plan - share tutorial privately (2) 
	Given I logged in iroad with user "premiumplanyearlyspecialdomainuser1" and password "validpassword" 
	...
	Given I logged in iroad with user "premiumplanyearlyspecialdomainuser2" and password "validpassword" 
	When I am at "/tutorials" 
...
Scenario: Premium Plan - use the mask data feature (3) 
	Given I logged in iroad with user "premiumplanyearlyspecialdomainuser1" and password "validpassword" 
...
Scenario: Premium Plan - change the privacy of the tutorial (4) 
	Given I logged in iroad with user "premiumplanyearlyspecialdomainuser1" and password "validpassword" 
 ...
 Scenario: Premium Plan - export PDF file (5) 
	Given I logged in iroad with user "premiumplanyearlyspecialdomainuser1" and password "validpassword" 
	When I am at "/tutorials" 
	When I click "tutorials.my_tutorial_tab"
	When I should see the My tutorials page content
...
Scenario: Premium Plan - check the audio feature (13) 
	Given I logged in iroad with user "premiumplanyearlyspecialdomainuser1" and password "validpassword" 
	When I should see the My tutorials page content
    And I search for "share private special domain" tutorial
    And I click "tutorials.three_dot_icon"
...
Scenario Outline: Premium Plan - check the customized theme feature (14) 
	Given I logged in iroad with user "premiumplanyearlyspecialdomainuser1" and password "validpassword" 
	When I click on the "left_menu.tutorials" button from the slide out menu
    Then I should see the My tutorials page content
   	And I search for "share private special domain" tutorial
...
@wip
Scenario: Premium Plan - create more 5 live tutorial than limit (15) 
	Given I am logged-in 
	And I already subscribed the PREMIUM plan 
...
Scenario: Premium Plan - View the statistics of a tutorial (16) 
	Given I logged in iroad with user "premiumplanyearlyspecialdomainuser1" and password "validpassword" 
	When I click on the "left_menu.tutorials" button from the slide out menu
    Then I should see the My tutorials page content
   	And I search for "share private special domain" tutorial
...
Scenario: Premium Plan - publish tutorials to your help center using intergration (17) 
	Given I logged in iroad with user "premiumplanyearlyspecialdomainuser1" and password "validpassword" 
